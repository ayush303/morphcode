...
import com.morphcode.ai.service.PaymentProcessor;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) {
        ...
        switch (type) {
            case "checkout.session.completed" -> handleCheckoutSessionCompleted((Session) stripeObject, metadata); // one-time,
                                                                                                                   // on
                                                                                                                   // checkout
                                                                                                                   // completed
            case "customer.subscription.updated" -> handleCustomerSubscriptionUpdated((Subscription) stripeObject); // when
                                                                                                                    // user
                                                                                                                    // cancels,
                                                                                                                    // upgrades
                                                                                                                    // or
                                                                                                                    // any
                                                                                                                    // updates
            case "customer.subscription.deleted" -> handleCustomerSubscriptionDeleted((Subscription) stripeObject); // when
                                                                                                                    // subscription
                                                                                                                    // ends,
                                                                                                                    // revoke
                                                                                                                    // the
            ...
            case "invoice.payment_failed" -> handleInvoicePaymentFailed((Invoice) stripeObject); // when invoice is not
                                                                                                 // paid, mark as
                                                                                                 // PAST_DUE
